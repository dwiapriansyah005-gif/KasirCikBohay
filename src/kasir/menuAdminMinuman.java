 ...
 * @author ACER
 */
public class menuAdminMinuman extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menuAdminMinuman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
