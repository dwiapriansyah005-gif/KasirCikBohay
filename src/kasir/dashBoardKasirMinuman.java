 ...
 * @author ACER
 */
public class dashBoardKasirMinuman extends javax.swing.JFrame {

    /**
     * Creates new form dashBoardKasir
     */
    public dashBoardKasirMinuman() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnMenuKasirMinuman.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
...
//        new dashBoardKasirMenu().setVisible(true);
    ...
    private void btnMenuKasirMinumanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMenuKasirMinumanActionPerformed
        // TODO add your handling code here:
//        setVisible(false);
//        new MenuKasirMinuman().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dashBoardKasirMinuman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
