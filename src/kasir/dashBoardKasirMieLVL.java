 ...
 * @author ACER
 */
public class dashBoardKasirMieLVL extends javax.swing.JFrame {

    /**
     * Creates new form dashBoardKasir
     */
    public dashBoardKasirMieLVL() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnMenuKasirMieLVL.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
...
//        new dashBoardKasirMieLVL().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dashBoardKasirMieLVL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
