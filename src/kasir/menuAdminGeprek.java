 ...
 * @author ACER
 */
public class menuAdminGeprek extends javax.swing.JFrame {

    /**
     * Creates new form dashboardAdmin
     */
    public menuAdminGeprek() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnGeprek.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
...
//        new menuAdminGeprek().setVisible(true);        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menuAdminGeprek.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
