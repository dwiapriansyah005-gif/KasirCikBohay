 ...
 * @author ACER
 */
public class dashBoardKasirGeprek extends javax.swing.JFrame {

    /**
     * Creates new form dashBoardKasir
     */
    public dashBoardKasirGeprek() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnMenuKasirGeprek.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
...
//        new dashBoardKasirGeprek().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dashBoardKasirGeprek.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
