 ...
 * @author ACER
 */
public class menuAdminSeblak extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menuAdminSeblak.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
