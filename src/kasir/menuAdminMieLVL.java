 ...
 * @author ACER
 */
public class menuAdminMieLVL extends javax.swing.JFrame {
...
//        new menuAdminMieLVL().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menuAdminMieLVL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
